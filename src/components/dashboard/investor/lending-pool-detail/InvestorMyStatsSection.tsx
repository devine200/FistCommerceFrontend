...
const InvestorMyStatsSection = ({ stats }: InvestorMyStatsSectionProps) => {
  return (
    <section className="rounded-[12px] border border-[#E6E8EC] bg-white p-6 lg:p-8 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
        <button
          type="button"
          className="bg-[#195EBC] text-white font-semibold text-[24px] py-4 rounded-[8px] w-full hover:bg-[#154a9a] transition-colors"
        >
          Invest
        </button>
        <button
          type="button"
          className="bg-[#E8EFFB] text-[#195EBC] font-semibold text-[24px] py-4 rounded-[8px] w-full border border-[#CFE0FF] hover:bg-[#DCE8FC] transition-colors"
        >
          Withdraw
        </button>
      </div>
