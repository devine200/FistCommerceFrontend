    ...
    <div className="max-w-[620px] mx-auto">
      <div className="flex items-start gap-2 mb-2 relative left-[-50px]">
        <button
          type="button"
          onClick={onBack}
          className="w-[50px] h-[40px] flex items-center justify-start relative left-[-20px]"
        >
      ...
      <button
        type="button"
        onClick={onContinue}
        className="mt-5 bg-[#195EBC] text-white px-5 py-3 rounded-md w-full text-[20px] font-semibold"
      >
        Continue
      </button>
    </div>
