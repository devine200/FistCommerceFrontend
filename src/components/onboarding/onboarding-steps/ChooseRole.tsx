...
const ChooseRole = ({ onContinueInvestor, onContinueMerchant }: ChooseRoleProps) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-[760px]">
        {/* Desktop keeps existing header; mobile uses the layout header/stepper */}
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-[40px] w-full">
            <div className="flex flex-col gap-4 w-full lg:w-[330px] justify-between items-center border border-[#EAEAEA] py-8 px-4">
