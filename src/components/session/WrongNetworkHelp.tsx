import { getAppChainManualAddDetails } from '@/wallet/appChainManualAdd'

export default function WrongNetworkHelp() {
  const details = getAppChainManualAddDetails()
  ...
  return (
    <div className="mt-4 w-full text-left text-xs leading-relaxed text-[#6B7280] space-y-3">
      <p>
        ...
        enable <span className="font-medium text-[#374151]">testnet mode</span> in your wallet settings,
        then add the network manually:
      </p>
      <dl className="rounded-lg bg-[#F9FAFB] p-3 space-y-1.5 font-mono text-[11px] break-all">
        <div>
