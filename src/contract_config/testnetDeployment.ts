...
type DeploymentJson = {
  ...
  PayoutRouter: { address: string; abi: Abi }
}
...
export const TESTNET_PAYOUT_ROUTER_ADDRESS = d.PayoutRouter.address as Address
export const TESTNET_MOCK_ERC20_ABI = d.MockERC20.abi
export const TESTNET_FUNDING_POOL_ABI = d.FundingPool.abi
export const TESTNET_PAYOUT_ROUTER_ABI = d.PayoutRouter.abi
