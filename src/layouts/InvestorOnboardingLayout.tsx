...
const OnboardingLayout = () => {
    ...
    const stepRoutes = [
        ...
        ...(isEmbedded ? ['/onboarding/investor/secure-key'] : []),
    ...
    const steps = [
        ...
        },
        {
            ...
            description:
                'Learn how the lending pool works, expected returns, and how your capital will be used to fund verified receivables.',
        },
